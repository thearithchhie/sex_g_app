...
class CustomScaffold extends StatelessWidget {
  ...
  final bool isHiddenBackground;
  final bool isShowBackIcon;
  final bool isShowHeaderLight;
  final bool isShowHeaderLightSecondary;
  final bool isShowHeaderLightSecondaryBackground;
  ...
  const CustomScaffold({
    ...
    this.isShowHeaderLight = false,
    this.isShowHeaderLightSecondary = false,
    this.isShowHeaderLightSecondaryBackground = false,
  });
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                gradient: gradient ??
                    (app.isDark
                        ? AppColor.primaryBgGradient
                        : AppColor.primaryBgGradientLight),
                image: isHiddenBackground
                    ? null
                    : DecorationImage(
            ...
            if (isShowHeaderLight) ...[
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: app.isDark
                      ? BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              const Color(0xff3138B0),
                              const Color(0xff3138B0).withAlpha(0)
                            ],
            ...
            if (isShowHeaderLightSecondary) ...[
              Positioned(
                ...
                child: Container(
                  height:
                      ContextHelper.padding.top + (context.height * (1 / 4.2)),
                  decoration: app.isDark
                      ? const BoxDecoration(
                          gradient: LinearGradient(
              ...
              if (isShowHeaderLightSecondaryBackground) ...[
                Positioned(
                  top: ContextHelper.padding.top + (context.height * (1 / 7)),
                  right: 0,
                  child: Opacity(
                    opacity: app.isDark ? 1 : 0.2,
                    child: SizedBox(
                      width: ContextHelper.padding.top +
                          (context.height * (1 / 10)),
                      child: AppSvg(Assets.svgs.dollarBg, fit: BoxFit.contain),
                    ),
                  ),
                ),
              ],
                    ...
                    if (isShowBackIcon)
                      SafeArea(
                          child: CustomBackIcon(
                              color: gradient != null ? AppColor.white : null)),
